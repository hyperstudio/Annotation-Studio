SwitchUser.setup do |config|
  ...
  # config.view_guard = ->(current_user, request) { current_user && current_user.admin? }
  ...
  config.controller_guard = ->(current_user, request, original_user) { current_user && current_user.admin? || original_user && original_user.admin? }
end
