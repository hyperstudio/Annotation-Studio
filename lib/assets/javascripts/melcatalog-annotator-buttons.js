...
tinymce.PluginManager.add('melcatalog', function( editor ) {
    ...
    function insertReference( eid, title ) {
        ...
        var tag = "<a class=\"catalog-popup\" data-parent data-gallery=\"remoteload\" href=\"" + url + "\">" + editor.dom.encode( title ) + "</a>";
    ...
    function insertImage( eid, image_src ) {
        ...
        var tag = "<a class=\"catalog-popup\" data-parent data-gallery=\"remoteload\" href=\"" + url + "\"><img src=\"" + image_src + "\"/></a>";
        editor.insertContent( tag );
    }
